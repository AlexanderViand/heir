...
// TODO: Once key analysis is added (e.g., rotation key generation based on
// actual rotation distances), this pass will need an entryFunction option to
// scope the analysis. For now it just copies scheme attributes.
