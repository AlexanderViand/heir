...
func.func @test_diagonals_not_shaped(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  %diagonals = arith.constant 1 : i32
...
func.func @test_diagonals_not_2d(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  ...
  %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0>} : tensor<4xf32>, tensor<4xf32> -> tensor<4xf32>
  return %0 : tensor<4xf32>
}
...
func.func @test_input_not_1d_or_2d(%arg0: tensor<1x2x3xf32>) -> tensor<1x2x3xf32> {
  ...
  %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0, 1>} : tensor<1x2x3xf32>, tensor<2x3xf32> -> tensor<1x2x3xf32>
...
func.func @test_slot_size_mismatch(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  ...
  %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0, 1>} : tensor<4xf32>, tensor<2x3xf32> -> tensor<4xf32>
  return %0 : tensor<4xf32>
}
...
func.func @test_diagonals_indices_mismatch(%arg0: tensor<4xf32>) -> tensor<4xf32> {
  ...
  %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0>} : tensor<4xf32>, tensor<2x4xf32> -> tensor<4xf32>
  return %0 : tensor<4xf32>
}
...
func.func @test_batch_dim_not_1(%arg0: tensor<2x4xf32>) -> tensor<2x4xf32> {
  ...
  %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0>} : tensor<2x4xf32>, tensor<1x4xf32> -> tensor<2x4xf32>
