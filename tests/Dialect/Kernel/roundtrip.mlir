...
module {
  ...
  func.func @test_linear_transform_tensor_2d(%arg0: tensor<1x4xf32>) -> tensor<1x4xf32> {
    ...
    %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0, 1>} : tensor<1x4xf32>, tensor<2x4xf32> -> tensor<1x4xf32>
  ...
  func.func @test_linear_transform_bsgs(%arg0: tensor<4xf32>) -> tensor<4xf32> {
    ...
    %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0, 1>, bsgs_ratio = 0.5 : f64} : tensor<4xf32>, tensor<2x4xf32> -> tensor<4xf32>
    return %0 : tensor<4xf32>
  }

  // CHECK: @test_linear_transform_lwe
  // CHECK: kernel.linear_transform %arg0, %{{.*}} {diagonal_indices = array<i64: 0, 1>}
  func.func @test_linear_transform_lwe(%arg0: tensor<1x!ciphertext_rlwe>) -> tensor<1x!ciphertext_rlwe> {
    ...
    %0 = kernel.linear_transform %arg0, %diagonals {diagonal_indices = array<i64: 0, 1>} : tensor<1x!ciphertext_rlwe>, tensor<2x1024xf64> -> tensor<1x!ciphertext_rlwe>
