// RUN: not heir-opt --annotate-orion="linear-transform-impl-style=diagonal-basic" --ckks-to-lwe --lwe-to-cheddar %s 2>&1 | FileCheck %s

// CHECK: error: 'orion.linear_transform' op requires Orion implementation style `opaque`, but got `diagonal-basic`
