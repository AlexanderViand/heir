...
#include "tests/Examples/orion/chebyshev/chebyshev_openfhe_flexible_auto_ext_lib.h"

namespace mlir {
namespace heir {
namespace openfhe {

TEST(ChebyshevOpenFheFlexibleAutoExtTest, RunTest) {
  ...
  std::cout
      << "chebyshev flexible-auto-ext call took: "
