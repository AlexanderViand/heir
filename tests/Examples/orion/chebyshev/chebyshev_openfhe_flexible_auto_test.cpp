...
#include "tests/Examples/orion/chebyshev/chebyshev_openfhe_flexible_auto_lib.h"

namespace mlir {
namespace heir {
namespace openfhe {

TEST(ChebyshevOpenFheFlexibleAutoTest, RunTest) {
  ...
  std::cout
      << "chebyshev flexible-auto call took: "
