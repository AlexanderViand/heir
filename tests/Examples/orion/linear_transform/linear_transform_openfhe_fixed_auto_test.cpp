...
#include "tests/Examples/orion/linear_transform/linear_transform_openfhe_fixed_auto_lib.h"

namespace mlir {
namespace heir {
namespace openfhe {

TEST(LinearTransformOpenFheFixedAutoTest, RunTest) {
  ...
  std::cout
      << "linear_transform fixed-auto call took: "
