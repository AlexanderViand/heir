...
#include "tests/Examples/orion/linear_transform/linear_transform_openfhe_flexible_auto_ext_lib.h"

namespace mlir {
namespace heir {
namespace openfhe {

TEST(LinearTransformOpenFheFlexibleAutoExtTest, RunTest) {
  ...
  std::cout
      << "linear_transform flexible-auto-ext call took: "
