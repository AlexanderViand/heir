...
#include "tests/Examples/orion/linear_transform/linear_transform_openfhe_flexible_auto_lib.h"

namespace mlir {
namespace heir {
namespace openfhe {

TEST(LinearTransformOpenFheFlexibleAutoTest, RunTest) {
  ...
  std::cout
      << "linear_transform flexible-auto call took: "
