// RUN: heir-opt --split-input-file --annotate-orion --lower-orion %s | FileCheck %s --check-prefix=BASIC
// RUN: heir-opt --split-input-file --annotate-orion="linear-transform-impl-style=opaque" --lower-orion %s | FileCheck %s
...
module {
  func.func @linear_transform_opaque(%ct: !ct_L5, %arg0: tensor<2x4096xf64>) -> !ct_L5 {
...
// BASIC-LABEL: func.func @linear_transform_opaque
// BASIC-NOT: orion.linear_transform
// BASIC: tensor.extract_slice
// BASIC: lwe.rlwe_encode
// BASIC: ckks.mul_plain
// BASIC: ckks.rotate
// BASIC: ckks.add
