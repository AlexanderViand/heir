// RUN: heir-opt --mlir-to-ckks='ciphertext-degree=8 openfhe-scaling-technique=fixed-manual' --scheme-to-openfhe='entry-function=dot_product openfhe-scaling-technique=fixed-manual' %s | FileCheck %s
