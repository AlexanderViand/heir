// RUN: heir-opt %s "--mlir-to-ckks=ciphertext-degree=4 modulus-switch-before-first-mul=true first-mod-bits=59 scaling-mod-bits=45" --scheme-to-cheddar | FileCheck %s
// RUN: heir-opt %s "--mlir-to-ckks=ciphertext-degree=4 modulus-switch-before-first-mul=true first-mod-bits=59 scaling-mod-bits=45 ckks-scale-policy=precise" --scheme-to-cheddar | FileCheck %s
